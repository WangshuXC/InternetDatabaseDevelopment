...
export default {
    data() {
        return {
            ...
            name: '张昊星',
            title: '数据库设计',
            image: 'https://avatars.githubusercontent.com/u/112965322?v=4',
            contactList: [
                {
                    color: '#c71610',
                    icon: 'fa-solid fa-envelope',
                    content: '2113419@mail.nankai.edu.cn',
                    link: 'mailto:2113419@mail.nankai.edu.cn'
                },
                {
                    color: '#171515',
                    icon: 'fa-brands fa-github',
                    content: 'fxingan',
                    link: 'https://github.com/fxingan'
                },
                {
                    color: '#1ed76d',
