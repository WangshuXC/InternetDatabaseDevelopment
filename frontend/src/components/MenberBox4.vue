...
export default {
    data() {
        return {
            ...
            name: '王思宇',
            title: '爬虫编写',
            image: 'https://avatars.githubusercontent.com/u/101002810?v=4',
            contactList: [
                {
                    color: '#c71610',
                    icon: 'fa-solid fa-envelope',
                    content: '2112414@mail.nankai.edu.cn',
                    link: 'mailto:2112414@mail.nankai.edu.cn'
                },
                {
                    color: '#171515',
                    icon: 'fa-brands fa-github',
                    content: 'thvarmy',
                    link: 'https://github.com/thvarmy'
                },
                {
                    color: '#1ed76d',
